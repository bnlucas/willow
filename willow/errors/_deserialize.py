...
class DeserializeError(WillowError):
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param message: Error message describing the deserialization failure.
        :param field: Optional dataclass field that caused the failure.
        :param value: Optional value that failed to deserialize.
        :param error: Optional original exception raised during deserialization.
        """
        self._field = field
        self._value = value
        self._error = error
    ...
    def field(
        ...
        :return: `dataclasses.Field` object or None.
        """
        return self._field
    ...
    def value(
        ...
        :return: The problematic value or None.
        """
        return self._value
    ...
    def error(
        ...
        :return: Original exception or None.
        """
        return self._error
