...
class ValidationError(WillowError):
    ...
    def __init__(
        ...
        *,
        ...
        :param field: The dataclass field that failed validation.
        :param value: The value of the field that failed validation.
        :param error: Optional original exception raised during validation.
        """
        self._field = field
        self._value = value
        self._error = error
    ...
    def field(
        ...
        :return: `dataclasses.Field` object.
        """
        return self._field
