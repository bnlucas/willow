...
class MemberCaptureProtocol(Protocol):
    ...
    :param member: The member (field or property) being processed.
    :param value: Current value of the member.
    :param stack: Stack used for iterative depth-first traversal of nested objects.
    :param dict_factory: Callable to construct dictionaries.
    :param list_factory: Callable to construct lists.
